 ...
 */
#include <stdio.h>//引入基本库 Include basic library
int main ()//主函数 main function
{
	int k, n=1;
	printf("请输入变量K   Please input var K:");
	scanf("%d",&k);//输入题目要求中整数 input the integer
	...
	printf("结果是  The result is：%d",n-1);//输出结果 Output result
	system("pause");
	return 0;
}
